            ...
            SettingsCard {
                ...
                SettingsRow {
                    ...
                    RowLayout {
                        ...
                        ColumnLayout {
                            spacing: 1
                            Text { text: "Dock settings"; color: cText; font.family: Theme.defaultFontFamily; font.pixelSize: 13; font.weight: Font.Medium }
                            Text { text: "Configure dock behavior and appearance"; color: cTextDim; font.family: Theme.defaultFontFamily; font.pixelSize: 11; opacity: 0.8 }
                        }
                    }
                    Item { Layout.fillWidth: true }

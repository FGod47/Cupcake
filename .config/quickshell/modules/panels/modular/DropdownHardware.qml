...
Item {
    ...
    readonly property real collapsedH: 84 + padTop + padBottom
    readonly property real expandedH: collapsedH + sinkListCol.implicitHeight + 12
    readonly property real targetH: showSinkList ? expandedH : collapsedH

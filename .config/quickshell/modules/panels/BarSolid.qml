...
PanelWindow {
    ...
    Rectangle {
        ...
        Behavior on x { enabled: !expandAnim.running; NumberAnimation { duration: 850; easing.type: Easing.OutExpo } }
        width: (bar.barW) 
        ...
        Behavior on width { enabled: !expandAnim.running; NumberAnimation { duration: 850; easing.type: Easing.OutExpo } }

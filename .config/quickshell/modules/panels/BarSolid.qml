...
PanelWindow {
    ...
    Rectangle {
        ...
        x: bar.dropdownOpen ? (globalState.solidBoardOpen ? (bar.barX + bar.barW - 36 - 10 - clockSplitPill.contentW - 10 - contentW) : (bar.barX + bar.barW - clockSplitPill.contentW - 10 - contentW)) : (bar.barX + bar.barW - 120)

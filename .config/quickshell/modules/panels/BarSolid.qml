...
PanelWindow {
    ...
    Rectangle {
        ...
        Behavior on x { enabled: !expandAnim.running; NumberAnimation { duration: 700; easing.type: Easing.OutExpo } }
        width: (bar.barW) 
        ...
        Behavior on width { enabled: !expandAnim.running; NumberAnimation { duration: 700; easing.type: Easing.OutExpo } }

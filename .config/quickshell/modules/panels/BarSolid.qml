...
PanelWindow {
    ...
    Rectangle {
        ...
        // When open: slides out to the far right edge as solidBar shrinks
        x: (globalState.solidBoardOpen || bar.dropdownOpen) ? (bar.barX + bar.barW - contentW) : (bar.barX + bar.barW - 220)

...
_write_default ".dock_reserve_space"            "false"
_write_default ".dock_shape"                    "35"
...
_write_default ".dock_pinned_apps"              '[{"name":"Files","appId":"org.gnome.Nautilus","exec":"nautilus --new-window"},{"name":"Google Chrome","appId":"google-chrome","exec":"/usr/bin/google-chrome-stable"},{"name":"kitty","appId":"kitty","exec":"kitty"},{"name":"Antigravity IDE","appId":"antigravity-ide","exec":"/usr/bin/antigravity-ide"}]'
_write_default ".dock_icon_size"                "48"
_write_default ".dock_main_axis_padding"        "6"
_write_default ".dock_cross_axis_padding"       "2"
_write_default ".dock_item_spacing"             "0"
_write_default ".dock_ends_margin"              "0"
_write_default ".dock_edge_margin"              "13"
_write_default ".dock_opacity"                  "1.00"
